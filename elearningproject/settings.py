...
SECRET_KEY = 'django-insecure-&v%=@gy_%ve+ye4yz91!ga3g_(j_p&-l)a14(haxa7&81-vg6$'
...
SESSION_EXPIRE_AT_BROWSER_CLOSE = False  # Set to True to expire when the browser is closed
